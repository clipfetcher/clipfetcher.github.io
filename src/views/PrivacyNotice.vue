<template>
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to clipfetcher.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to clipfetcher, accessible from
          <a
            href="https://clipfetcher.com/"
            rel="external nofollow noopener"
            target="_blank"
            >https://clipfetcher.com/</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: clipfetcher@gmail.com</li>
    </ul>
  </div>
</template>